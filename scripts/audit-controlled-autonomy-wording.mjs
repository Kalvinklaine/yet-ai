...
const docsAllowlist = [
  ...
  "docs/architecture/018-controlled-agent-authority-registry.md",
  "docs/architecture/029-vscode-controlled-task-harness.md",
  "docs/architecture/030-controlled-agent-workflow-transcript.md",
  "docs/architecture/031-controlled-agent-storage-privacy-inventory.md",
  "docs/architecture/032-controlled-agent-verification-setup-hardening.md",
  "docs/architecture/033-packaged-vscode-controlled-task-smoke.md",
