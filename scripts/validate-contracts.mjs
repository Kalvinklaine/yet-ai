...
const invalidMappings = [
  ...[
    ...
    ["project-summary-zero-revision.json", "project-summary.schema.json"],
    ...
    ["project-update-zero-revision.json", "project-update-request.schema.json"],
    ...
    ["project-lifecycle-zero-revision.json", "project-lifecycle-request.schema.json"],
