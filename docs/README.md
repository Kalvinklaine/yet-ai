...
- `architecture/017-controlled-agent-production-gap-audit.md` — S107 production-readiness gap audit scaffold for the controlled-agent path. It records evidence needed before any production-like autonomous-agent claim across security, authority, UX, CI/CD, host parity, recovery, persistence/privacy, performance, packaging, provider dogfood, and observability while keeping current status dev-preview only.
