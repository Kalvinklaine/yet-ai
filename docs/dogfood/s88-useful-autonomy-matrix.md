...
Future implementation cards may add focused S88 fixture smokes, but this matrix deliberately does not add a runnable smoke command. The tiny raccoon of autonomy gets a map today, not keys to the pantry.
