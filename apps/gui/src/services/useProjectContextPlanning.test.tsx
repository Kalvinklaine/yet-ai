...
function plan(mode: "manual_only" | "balanced" | "deep" = "balanced", planId = "plan-1", targetProjectId = projectId) {
  return { protocolVersion: "2026-08-02", schemaVersion: 1, planId, projectId: targetProjectId, mode, queryLabel: "Find start", status: "ready", manifest: { protocolVersion: "2026-08-02", schemaVersion: 2, manifestId: `manifest-${planId}`, projectId: targetProjectId, planId, mode, inventoryGeneration: 3, queryHash: hash, rankingVersion: "lexical-symbol-ranking-1", budget: { maxFiles: 12, maxChunks: 32, maxBytes: 131072, maxEstimatedTokens: 24000, usedFiles: 1, usedChunks: 1, usedBytes: 100, usedEstimatedTokens: 25, truncated: false }, entries: [{ kind: "file_chunk", chunkId: "chunk-1", sourceRef: "src/main.ts", range: { start: { line: 0, character: 0 }, end: { line: 4, character: 2 } }, contentHash: hash, inclusionReason: "lexical_match", provenance: "lexical", redaction: "none", byteCount: 100, estimatedTokens: 25, rank: 1 }], omissions: [], redaction: { metadataOnlyCount: 0, contentRedactedCount: 0, omittedCount: 0 }, createdAt: "2026-08-02T12:00:00Z" }, createdAt: "2026-08-02T12:00:00Z", expiresAt: "2026-08-02T12:05:00Z", cloudRequired: false };
}
