...
Login/account-based GPT first-message UX is a mandatory future milestone. The experimental Codex-like account path remains separate, explicit-risk, mock-only in automation, and not the default GUI first-message path.
