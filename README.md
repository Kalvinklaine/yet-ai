...
Current real-provider testing should use the official OpenAI API-key or project-key fallback through the local runtime. This remains the safe/default path.
