...
| Confirmed edit proposal preview | Supported | Preview-only |
| Confirmed edit proposal apply | Supported only through bounded confirmed VS Code path | Intentional gap; no apply path |
